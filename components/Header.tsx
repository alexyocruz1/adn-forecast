...
export default function Header() {
  ...
  return (
    <header className="w-full border-b border-border bg-bg-primary/80 backdrop-blur-md sticky top-0 z-50">
      {/* Top accent bar */}
      <div className="h-1 w-full bg-gradient-to-r from-green-glow to-green-brand"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-6">
            <div className="hidden md:block font-body text-sm text-text-soft">
              {displayDate}
            </div>
            ...
            <a 
              ...
              className="flex items-center gap-2 bg-bg-card hover:bg-bg-card-hover hover:text-green-glow border border-border px-4 py-2 rounded-full transition-colors text-sm font-body font-medium"
            >
